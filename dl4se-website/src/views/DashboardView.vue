        ...
        <b-col>
          ...
          >
            ...
            <template #cell(details)="row">
              <b-icon-patch-check-fill v-if="row.item.verified" title="Email Verified" class="mr-1" />
              <b-icon-patch-question-fill v-else title="Email Unverified" class="mr-1" />
              <b-iconstack :title="(row.item.enabled ? '' : 'Disabled ') + toTitleCase(row.item.role)">
            ...
            <template #cell(actions)="row">
              <div class="d-lg-table-cell d-inline-flex">
                <b-button class="action-btn mr-1" size="sm"
                          :title="!row.item.enabled ? 'Enable' : 'Disable'"
                ...
                <b-button class="action-btn" size="sm"
                          :title="row.item.role === 'ADMIN' ? 'Demote' : 'Promote'"
