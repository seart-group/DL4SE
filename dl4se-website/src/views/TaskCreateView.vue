          ...
          <b-col xl="5" lg="6" md="9" cols="12">
            <b-form-group label-class="font-weight-bold" class="m-0">
              ...
              <b-form-text v-show="task.query.include_ast" class="pl-4">
                ...
                the size of the exported file, and may increase the amount of time needed to export
                individual instances if processing is applied.
              </b-form-text>
            </b-form-group>
          </b-col>
        </b-row>
              ...
              <b-col xl="3" lg="4" md="12" sm="12" cols="12">
                <b-form-group label-class="font-weight-bold">
                  ...
                  <b-checkbox
                    ...
                    v-model="task.processing.remove_docstring"
                    inline
                  >
                    Docstrings
                  </b-checkbox>
                  <b-checkbox
                    ...
                    v-model="task.processing.remove_inner_comments"
                    inline
                  >
                    Inner comments
                  </b-checkbox>
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      await this.$http.post(endpoint, payload).then(this.submitSuccess).catch(this.submitFailure)
    },
    async getLanguages() {
      const endpoint = "/language"
      await this.$http.get(endpoint).then((res) => {
